...
class MiscCell: BaseCell,Reusable,TextInputDelegate
{
    //MARK:- IBOutlets
    ...
    {
        return UINib(nibName: String(describing:MiscCell.self), bundle: nil)
    }
...
extension MiscCell: UITextFieldDelegate
{
