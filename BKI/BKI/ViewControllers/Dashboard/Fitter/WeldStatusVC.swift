...
//        params["event"] = event as AnyObject
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.gasIdTF.isHidden = (role == 2 && self.spool!.isHPCategory!) ? false : true
        cell?.gasIdDropDownBtn.isHidden = role == 2 && self.spool!.isHPCategory! ? false:true
        ...
        cell!.markAsCompletedBlock = {
            ...
            if (!((cell?.statusTF.text?.isEmpty)!) && !(self.spool!.isHPCategory!)) || (!((cell?.statusTF.text?.isEmpty)!) && !(cell?.gasIdTF.text!.isEmpty)!)  || self.role == 1{
