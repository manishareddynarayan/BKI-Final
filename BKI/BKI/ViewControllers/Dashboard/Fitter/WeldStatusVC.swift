...
class WeldStatusVC: BaseViewController
{
    ...
    {
        super.viewDidLoad()
        tableView.registerReusableCell(WeldCell.self)
...
extension WeldStatusVC:UIPickerViewDelegate, UIPickerViewDataSource
{
...
// MARK:- Table view data source
extension WeldStatusVC : UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:WeldCell = tableView.dequeueReusableCell(indexPath: indexPath) as WeldCell
